...
import sys
sys.path.extend([item[0] for item in os.walk(os.path.join(os.path.dirname("torch_homography_model.py"), "DeepHomography"))])
sys.path.extend([item[0] for item in os.walk(os.path.join(os.path.dirname("dataset.py"), "DeepHomography"))])
sys.path.extend([item[0] for item in os.walk(os.path.join(os.path.dirname("utils.py"), "DeepHomography"))])

from torch_homography_model import build_model
from dataset import *
from utils import transformer as trans, display_using_tensorboard
