...
def test(args):
    ...
    # Small-Foregrounds images
    SF = ['00000244', '00000251', '0000026', '0000034', '00000115']
    # Large-foregrounds images
    ...
    net = build_model(args.model_name, pretrained=args.pretrained)  # ResNet part
    if args.finetune == True:
        model_path = os.path.join(exp_name, 'models')  # Take weights for the rest
        model_path = os.path.join(model_path, 'freeze-mask-first-fintune.pth' )
        print(model_path)
    ...
    net = torch.nn.DataParallel(net) # Para procesamiento paralelo
    ...
    for i, batch_value in enumerate(test_loader):
        ...
        H_mat = batch_out['H_mat'] # Matriz de homografía
